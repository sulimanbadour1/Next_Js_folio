...
function WorkExperience({}: Props) {
  return (
    ...
    >
      <h3 className="absolute top-32 uppercase tracking-[8px] text-gray-200 text-3xl">
        Work Experience.
      </h3>
      ...
      <div className="w-full flex space-x-2 overflow-x-scroll pt-20 snap-x snap-mandatory ">
