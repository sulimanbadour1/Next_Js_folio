...
function WorkExperience({}: Props) {
  return (
    ...
    >
      <h3 className="absolute top-32 text-xl uppercase tracking-[8px] text-gray-200 md:text-3xl">
        Work Experience.
      </h3>
      {/* <h3 className="absolute pt-12 top-36 uppercase tracking-[3px] text-gray-200 text-sm md:pb-4 flex flex-row items-center justify-center">
        Where I've worked so far.
      </h3> */}
      <div
        className="w-full flex space-x-2 overflow-x-scroll pt-20 snap-x snap-mandatory
      scrollbar
